      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white border-4 border-slate-900 shadow-[6px_6px_0px_0px_rgba(15,23,42,1)] p-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-6">
            <div className="border border-purple-100 border-4 border-slate-900 p-6">
              ...
              <a
                ...
                className="mt-4 inline-flex items-center gap-2 text-teal-700 font-semibold hover:underline"
              >
                {CONTACT_EMAIL}
