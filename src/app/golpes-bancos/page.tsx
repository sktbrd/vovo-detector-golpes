  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <div className="container mx-auto px-4 py-16 max-w-6xl">
        ...
        {/* Articles Grid */}
        <h2 className="text-4xl font-black mb-8 text-center">📚 Artigos sobre Golpes Bancários</h2>
        ...
        <div className="bg-yellow-50 border-4 border-yellow-500 p-8 mb-16">
          <h2 className="text-3xl font-black mb-4 text-yellow-800">⚠️ Atenção: Regra de Ouro</h2>
