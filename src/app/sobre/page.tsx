      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="mt-10 border-t border-gray-100 pt-8">
            <h3 className="text-xl font-bold text-purple-800 mb-3">Boas práticas ao receber uma mensagem</h3>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3">
            ...
            <Link
              href="/contato"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white border border-purple-200 text-purple-700 font-semibold rounded-xl hover:bg-purple-50 transition-colors"
            >
